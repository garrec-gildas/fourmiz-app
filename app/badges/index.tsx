...
const mockBadgesData = {
  ...
  badges: [
    {
      id: 'earnings-champion',
      name: 'Client des Gains',
      description: 'Récompense les plus gros gains cumulés du mois',
      value: 50,
      currency: '€',
      isUnlocked: true,
      ...
      category: 'earnings',
      requirement: 'Gagner plus de 1000€ en un mois',
      progress: 100,
      rarity: 'legendary'
    },
    {
    ...
    },
    {
      ...
      description: 'Récompense la plus grosse commission unique du mois',
      value: 30,
      currency: '€',
      isUnlocked: true,
      ...
      category: 'commission',
      requirement: 'Obtenir une commission de plus de 30€',
      progress: 100,
      rarity: 'epic'
    },
    {
    ...
    },
    {
      id: 'perfect-rating',
      name: 'Client Parfait',
      description: 'Maintenir une note de 5/5 sur 10 commandes consécutives',
      value: 20,
      currency: '€',
      isUnlocked: true,
      ...
      category: 'quality',
      requirement: '10 commandes consécutives avec 5/5',
      progress: 100,
      rarity: 'epic'
    },
    {
      id: 'missions-champion',
      name: 'Client Cardio',
      description: 'Récompense le plus grand nombre de services commandés du mois',
      value: 15,
      currency: '€',
      isUnlocked: true,
      ...
      category: 'missions',
      requirement: 'Réaliser plus de 15 commandes en un mois',
      progress: 100,
      rarity: 'rare'
    },
    {
...
export default function BadgesScreen() {
  ...
  // Adapter les noms des badges selon le mode
  const badges = React.useMemo(() => {
    return mockBadgesData.badges.map(badge => {
      if (isFourmizMode) {
        // Si on est en mode Fourmiz, on garde les noms originaux
        return badge;
      } else {
        // Si on est en mode Client, on remplace "Fourmiz" par "Client" dans les noms
        return {
          ...badge,
          name: badge.name.replace('Fourmiz', 'Client')
        };
      }
    });
  }, [isFourmizMode]);
        ...
        >
          <View style={styles.heroContent}>
            ...
            <Text style={styles.heroSubtitle}>
              Découvrez les badges que vous avez débloqués grâce à votre activité mensuelle
            </Text>
            <View style={styles.heroStats}>
              ...
              <View style={styles.heroStat}>
                ...
                <Text style={styles.heroStatLabel}>récompenses gagnées</Text>
              </View>
            </View>
          </View>
        </LinearGradient>
        ...
        <View style={styles.noticeSection}>
          <View style={styles.noticeCard}>
            ...
            <Text style={styles.noticeText}>
              <Text style={styles.noticeHighlight}>Les scores et gains affichés sont calculés mensuellement</Text> et 
              comparés aux autres {isFourmizMode ? 'Fourmiz' : 'Clients'} de votre zone géographique départementale.
            </Text>
        ...
        <View style={styles.progressSection}>
          ...
          <View style={styles.overallProgressCard}>
            ...
            <Text style={styles.progressSubtext}>
              Continuez vos efforts pour débloquer tous les badges mensuels !
            </Text>
          </View>
        </View>
          ...
          <View style={styles.performanceGrid}>
            <View style={styles.performanceCard}>
              ...
              <Text style={styles.performanceValue}>
                {mockBadgesData.currentMonth.earnings.toFixed(0)}€
              </Text>
              <Text style={styles.performanceLabel}>Gains mensuels</Text>
            </View>
            
            <View style={styles.performanceCard}>
              <Trophy size={24} color="#FF9800" />
              <Text style={styles.performanceValue}>
                {mockBadgesData.currentMonth.missions}
              </Text>
              <Text style={styles.performanceLabel}>Missions ce mois</Text>
            </View>
            
            <View style={styles.performanceCard}>
              <Star size={24} color="#9C27B0" />
              <Text style={styles.performanceValue}>
                {mockBadgesData.currentMonth.maxCommission.toFixed(0)}€
              </Text>
              <Text style={styles.performanceLabel}>Plus grosse commission</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.tipsSection}>
          ...
          <View style={styles.tipCard}>
            ...
            <View style={styles.tipContent}>
              <Text style={styles.tipTitle}>Restez actif</Text>
              <Text style={styles.tipText}>
                Plus vous {isFourmizMode ? 'réalisez de missions' : 'passez de commandes'}, plus vous avez de chances de débloquer des badges !
              </Text>
            </View>
          </View>
          ...
          <View style={styles.tipCard}>
            ...
            <View style={styles.tipContent}>
              <Text style={styles.tipTitle}>Visez l'excellence</Text>
              <Text style={styles.tipText}>
                {isFourmizMode 
                  ? 'Maintenez une note élevée et répondez rapidement pour débloquer les badges de qualité.'
                  : 'Donnez des notes justes et détaillées pour aider la communauté et débloquer des badges.'}
              </Text>
            </View>
          </View>
          ...
          <View style={styles.tipCard}>
            ...
            <View style={styles.tipContent}>
              <Text style={styles.tipTitle}>{isFourmizMode ? 'Variez vos horaires' : 'Essayez différents horaires'}</Text>
              <Text style={styles.tipText}>
                {isFourmizMode 
                  ? 'Travaillez tôt le matin ou tard le soir pour débloquer les badges horaires spéciaux.'
