...
const mockEarningsData = {
  ...
  badgesRewards: [
    { 
      id: '1',
      name: 'Fourmiz Express',
      description: 'Plus grand nombre de commandes en 24h',
      amount: 10.00,
      date: '2024-12-17',
      icon: '⚡'
    },
    { 
      id: '2',
      name: 'Fourmiz Parfait',
      description: '10 notes 5/5 consécutives',
      amount: 20.00,
      date: '2024-12-10',
      icon: '⭐'
    },
    { 
      id: '3',
      name: 'Fourmiz Cardio',
      description: 'Plus grand nombre de missions du mois',
      amount: 15.00,
      date: '2024-11-30',
      icon: '🏃'
    },
    { 
      id: '4',
      name: 'Fourmiz Force One',
      description: 'Plus grosse commission unique du mois',
      amount: 30.00,
      date: '2024-11-18',
      icon: '💪'
    },
    { 
      id: '5',
      name: 'Fourmiz Social',
      description: 'Plus grand nombre de parrainages du mois',
      amount: 50.00,
      date: '2024-10-31',
      icon: '👥'
    }
...
export default function EarningsScreen() {
  ...
  const [showBadgesRewards, setShowBadgesRewards] = useState(false);
  ...
  const renderBadgeReward = ({ item }: { item: any }) => (
    <View style={styles.badgeRewardCard}>
      <View style={styles.badgeRewardHeader}>
        <View style={styles.badgeRewardIcon}>
          <Text style={styles.badgeRewardEmoji}>{item.icon}</Text>
        </View>
        <View style={styles.badgeRewardInfo}>
          <Text style={styles.badgeRewardName}>{item.name}</Text>
          <Text style={styles.badgeRewardDescription}>{item.description}</Text>
        </View>
        <Text style={styles.badgeRewardAmount}>+{item.amount.toFixed(2)}€</Text>
      </View>
      <Text style={styles.badgeRewardDate}>
        Obtenu le {new Date(item.date).toLocaleDateString('fr-FR')}
      </Text>
    </View>
  );
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.breakdownCard}>
            ...
            <View style={styles.breakdownItem}>
              ...
              <TouchableOpacity 
                ...
                onPress={() => setShowBadgesRewards(!showBadgesRewards)}
              >
                <Text style={styles.viewBadgesText}>
                  {showBadgesRewards ? 'Masquer' : 'Détails'}
                </Text>
              </TouchableOpacity>
            </View>
          </View>
        ...
        {showBadgesRewards && (
          <View style={styles.badgesRewardsSection}>
            <Text style={styles.sectionTitle}>Récompenses des badges</Text>
            <Text style={styles.badgesRewardsDescription}>
              Vos badges vous ont rapporté {mockEarningsData.breakdown.badgesRewards.toFixed(2)}€ au total
            </Text>
            
            <View style={styles.badgesRewardsList}>
              {mockEarningsData.badgesRewards.map((badge) => (
                <View key={badge.id}>
                  {renderBadgeReward({ item: badge })}
                </View>
              ))}
            </View>
            ...
            >
              ...
              <Text style={styles.viewAllBadgesText}>Voir tous mes badges</Text>
            </TouchableOpacity>
          </View>
        )}
